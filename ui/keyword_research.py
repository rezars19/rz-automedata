...
class KeywordResearchMixin:
    ...
    def _build_keyword_research_page(self, parent):
        ...
        ctk.CTkLabel(
            header, text="🔍  Keyword Research — Adobe Stock",
        ...
        asset_types = [("🖼  All", "all"), ("📷  Photos", "photo"), ("🎨  Vectors", "vector"), ("🎬  Videos", "video")]
        ...
        self.kr_analyze_btn = ctk.CTkButton(
            search_frame, text="🚀  Analyze", command=self._kr_start_analysis,
    ...
    def _kr_show_empty_state(self):
        ...
        tips = [
            "• Use commas to research multiple keywords at once",
            "• 🟢 HIGH opportunity = less competition, easier to rank",
            "• 🔴 LOW opportunity = very saturated market",
            "• Select asset type (Photo/Vector/Video) for specific results",
            "• Click keyword rows to open Adobe Stock search page",
            "• AI generates related keywords using your configured provider",
        ]
        for tip in tips:
            ctk.CTkLabel(
                tips_frame, text=tip,
    ...
    def _kr_start_analysis(self):
        ...
        # Update UI
        self.kr_analyze_btn.configure(text="⏹  Stop", fg_color=COLORS["error"])
        ...
        ctk.CTkLabel(
            self.kr_related_scroll,
            text="⏳ Waiting for AI to generate related keywords...",
            font=ctk.CTkFont(size=11), text_color=COLORS["text_muted"],
            justify="center"
        ).pack(pady=30)
    ...
    def _kr_create_result_row(self, idx, keyword):
        ...
        link_btn = ctk.CTkButton(
            link_cell, text="🔗", width=28, height=28, corner_radius=6,
    ...
    def _kr_on_keyword_done(self, result):
        ...
        if total < 0:
            row["results_label"].configure(text="⚠️ Error", text_color=COLORS["error"])
    ...
    def _kr_show_related_no_api(self):
        ...
        self.kr_related_status.configure(text="⚠️ no API key")
    ...
    def _kr_on_related_keyword_done(self, result):
        """Called when a single related keyword lookup is done — add card to related panel."""
    ...
    def _kr_on_related_complete(self, original_keyword, related_results):
        ...
        self.kr_related_status.configure(text=f"✅ {len(related_results)} keywords")
